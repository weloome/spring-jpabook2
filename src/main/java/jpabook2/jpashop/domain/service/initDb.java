...
import jpabook2.jpashop.domain.*;
import jpabook2.jpashop.domain.item.Book;
import lombok.RequiredArgsConstructor;
import org.springframework.stereotype.Component;
import org.springframework.transaction.annotation.Transactional;

@Component // spring이 컴포넌트의 대상이됨
@RequiredArgsConstructor
public class initDb {

    private final InitService initService;

    @PostConstruct // 애플리케이션 로딩시점에 실행
    public void init() {
        initService.dbInit1();
        initService.dbInit2();
    }
    ...
    static class InitService {
        ...
        public void dbInit1() {
            Member member = createMember("제제", "냥이별", "1", "1111");
            em.persist(member);
        ...
        public void dbInit2() {
            Member member = createMember("아지", "강쥐별", "2", "2222");
            em.persist(member);
